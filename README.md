...
<head>
  ...
  <link rel="icon" href="file:///C:/Users/MIL/OneDrive/Imagens/logo-bcj.png.png" type="image/png">
...
<body>
  <header>
    <img src="logo-bcj.png" alt="Logo BCJ">
  ...
  <section id="servicos">
    ...
    <div class="gif-container">
      ...
      <section id="aluguel">
      <section id="aluguel">
  <h2>Aluguel de Impressoras</h2>
  <p>
    Oferecemos soluções de aluguel de impressoras para empresas e profissionais que precisam de qualidade, economia e suporte técnico incluso.
  </p>

  <div class="cards">
    <div class="card">
      <img src="https://www.logicsystems.com.br/wp-content/uploads/2021/09/aluguel-de-impressoras.jpg" alt="Impressora em aluguel">
      <p>Planos mensais com manutenção e suprimentos inclusos.</p>
    </div>
    <div class="card">
      <img src="https://www.zbra.com.br/images/blog/como-funciona-o-aluguel-de-impressoras.jpg" alt="Locação empresarial">
      <p>Equipamentos modernos para escritórios e empresas.</p>
    </div>
    <div class="card">
      <img src="https://sistemasul.com.br/wp-content/uploads/2020/10/aluguel-de-impressoras-scaled.jpg" alt="Contrato de aluguel">
      <p>Contratos flexíveis e atendimento técnico especializado.</p>
    </div>
  </div>

  
  <p style="text-align: center; margin-top: 20px;">
    <a href="pag002.html" target="_blank" class="toggle-btn">Soluções de Aluguel</a>
  </p>
</section>
    ...
    <h2>Sobre Nós</h2>
    <p>
      Uma empresa focada na prestação de serviços de manutenção preventiva e corretiva em equipamentos de informática, é especializada em soluções de outsourcing de impressão, oferecendo serviços completos para a gestão eficiente de parques de impressão corporativo.
    </p>
    <p>
      Atuamos com foco na redução de custos, aumento da produtividade e sustentabilidade, por meio da terceirização de equipamentos, suprimentos, manutenção e monitoramento remoto.
    </p>
    <p>
      Com tecnologia de ponta, suporte técnico ágil e consultoria personalizada, ajudamos empresas de todos os portes a otimizarem seus processos de impressão e digitalização de documentos. Nosso compromisso é garantir maior controle, segurança da informação e eficiência operacional para que nossos clientes possam concentrar seus recursos em atividades estratégicas do negócio.
    </p>
  </section>
  ...
  <a href="https://www.instagram.com/p/CwA6YrGO8TT/" class="instagram-float" target="_blank">
